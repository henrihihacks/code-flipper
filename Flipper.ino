...
void setup() {
 ...
 Serial.begin(9600);
  ...
  pinMode(IR4, INPUT);
  pinMode(IR5, INPUT);
  pinMode(shot1, INPUT_PULLUP);
  pinMode(shot2, INPUT_PULLUP);
  pinMode(champ1, INPUT_PULLUP);
  pinMode(champ2, INPUT_PULLUP);
...
void loop() {
    ...
    if(digitalRead(piezo0)==LOW){ //Marquer des points avec les cibles
      if(passagepiezzo0==0){points=points+5;leds[0] = CRGB(0, 255, 0);}
      if(passagepiezzo0==1){points=points+10;leds[0] = CRGB(255, 0, 0);}
      if(passagepiezzo0==2){points=points+20;leds[0] = CRGB(0, 0, 0);}
      passagepiezzo0++;
      if(passagepiezzo0==3){passagepiezzo0=0;leds[0] = CRGB(0, 0, 255);}
      FastLED.show();
      u8g2.clearBuffer();          // clear the internal memory
      u8g2.setCursor(5, 30);
      u8g2.print(points); // write something to the internal memory
      ...
      if(passagepiezzo1==0){points=points+5;leds[1] = CRGB(0, 255, 0);}
      if(passagepiezzo1==1){points=points+10;leds[1] = CRGB(255, 0, 0);}
      if(passagepiezzo1==2){points=points+20;leds[1] = CRGB(0, 0, 0);}
      passagepiezzo1++;
      if(passagepiezzo1==3){passagepiezzo1=0;leds[1] = CRGB(0, 0, 255);}
      FastLED.show();
      u8g2.clearBuffer();          // clear the internal memory
      u8g2.setCursor(5, 30);
      u8g2.print(points); // write something to the internal memory
      ...
      if(passagepiezzo2==0){points=points+5;leds[2] = CRGB(0, 255, 0);}
      if(passagepiezzo2==1){points=points+10;leds[2] = CRGB(255, 0, 0);}
      if(passagepiezzo2==2){points=points+20;leds[2] = CRGB(0, 0, 0);}
      passagepiezzo2++;
      if(passagepiezzo2==3){passagepiezzo2=0;leds[2] = CRGB(0, 0, 255);}
      FastLED.show();
      u8g2.clearBuffer();          // clear the internal memory
      u8g2.setCursor(5, 30);
      u8g2.print(points); // write something to the internal memory
      ...
      if(passagepiezzo3==0){points=points+5;leds[3] = CRGB(0, 255, 0);}
      if(passagepiezzo3==1){points=points+10;leds[3] = CRGB(255, 0, 0);}
      if(passagepiezzo3==2){points=points+20;leds[3] = CRGB(0, 0, 0);}
      passagepiezzo3++;
      if(passagepiezzo3==3){passagepiezzo3=0;leds[3] = CRGB(0, 0, 255);}
      FastLED.show();
      u8g2.clearBuffer();          // clear the internal memory
      u8g2.setCursor(5, 30);
      u8g2.print(points); // write something to the internal memory
      u8g2.sendBuffer();
        ...
        if(digitalRead(IR1)==LOW){ //Marquer des points avec les capteurs IR entre les portes
          if(passageIR1==0){points=points+5;leds[6] = CRGB(0, 255, 0);}
          if(passageIR1==1){points=points+10;leds[6] = CRGB(255, 0, 0);}
          if(passageIR1==2){points=points+20;leds[6] = CRGB(0, 0, 0);}
          passageIR1++;
          if(passageIR1==3){passageIR1=0;leds[6] = CRGB(0, 0, 255);}
          FastLED.show();
          u8g2.clearBuffer();          // clear the internal memory
          u8g2.setCursor(5, 30);
          u8g2.print(points); // write something to the internal memory
        ...
        if(digitalRead(IR2)==LOW){
          if(passageIR2==0){points=points+5;leds[5] = CRGB(0, 255, 0);}
          if(passageIR2==1){points=points+10;leds[5] = CRGB(255, 0, 0);}
          if(passageIR2==2){points=points+20;leds[5] = CRGB(0, 0, 0);}
          passageIR2++;
        ...
        if(digitalRead(IR3)==LOW){
          if(passageIR3==0){points=points+5;leds[4] = CRGB(0, 255, 0);}
          if(passageIR3==1){points=points+10;leds[4] = CRGB(255, 0, 0);}
          if(passageIR3==2){points=points+20;leds[4] = CRGB(0, 0, 0);}
          passageIR3++;
          if(passageIR3==3){passageIR3=0;leds[4] = CRGB(0, 0, 255);}
          FastLED.show();
          u8g2.clearBuffer();          // clear the internal memory
          u8g2.setCursor(5, 30);
          u8g2.print(points); // write something to the internal memory
          ...
          if (digitalRead(shot1)==LOW){//activer le premier slingshot
          ...
          if (digitalRead(champ1)==LOW){//activer le premier champignon (bumper)
